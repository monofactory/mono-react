        ...
        function e(t, r, n, o) {
            ...
            (this.onPopState = function (e) {
              ...
              if (t) {
                if (t.__N) {
                  ...
                  ;(m.isSsr && n === I(m.asPath) && i === I(m.pathname)) ||
                    (m._bps && !m._bps(t)) ||
                    m.change(
                      'replaceState',
                      r,
                ...
                m.changeState(
                  'replaceState',
                  j.formatWithValidation({ pathname: I(u), query: c }),
                  b.getURL()
                )
              }
            })
          ...
          if (
            ...
            ;(S._shouldResolveHref = n !== t),
              this.changeState(
                'replaceState',
                j.formatWithValidation({ pathname: I(t), query: r }),
                b.getURL(),
                S
              )
          }
                      ...
                      function (o) {
                        for (;;)
                          switch ((o.prev = o.next)) {
                            ...
                            case 3:
                              ;(l =
                                a._h || a._shouldResolveHref || L(r) === L(n)),
                                (v = s({}, c.state)),
                                a._h && (c.isReady = !0),
                                (m = v.locale),
                                (o.next = 19)
                            ...
                            case 55:
                              if (
                                ...
                                (X = n),
                                (W = W ? p.removePathTrailingSlash(N(W)) : W),
                                !l || '/_error' === W)
                              ) {
                                o.next = 70
                                break
                            ...
                            case 117:
                              ...
                              return (
                                ((he = _.parseRelativeUrl(de)).pathname = B(
                                  he.pathname,
                                  G
                                )),
                                (ye = H(c, de, de)),
                              ...
                              return (
                                (c = _.parseRelativeUrl(
                                  m.normalizeLocalePath(
                                    T(u.rewrite) ? N(u.rewrite) : u.rewrite,
                                    t.locales
                                  ).pathname
                                )),
                            ...
                            case 28:
                              ...
                              return (
                                (h = p.removePathTrailingSlash(
                                  m.normalizeLocalePath(
                                    T(u.redirect) ? N(u.redirect) : u.redirect,
                                    t.locales
                                  ).pathname
                                )),
                                (y = H(t, h, h)),
